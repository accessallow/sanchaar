<div class='row-fluid'>
  ...
  <a class="btn" href="<?php echo URL.'index.php/student/inbox/'.$message['id']; ?>"><i class='icon-eye-open'></i></a>
  <button class="btn"><i class='icon-retweet'></i></button>
    ...
    <div class='span4'>
        <table class='table table-bordered'>
            ...
            <tr>  
            <form action='<?php echo URL.'index.php/student/inbox';?>' id='frm1' method='post'>
    <input type='hidden' name='sender' value = "<?php if(isset($msg)) echo $msg['sender_username'];?>"/>
