<div class="row-fluid">
    <div class="span11">
        <table class="table table-bordered">
            ...
            <tr>
                  <form id='frm1' action="<?php echo URL.'index.php/student/search'; ?>" method='post'>
    ...
    <div class="span11">
        ...
        <table class="table table-bordered">
          ...
          <tr>
                ...
                <td class='span2'><a href='<?php echo URL.'index.php/student/profile/'.$student['roll_number'];?>'>View Profile</a></td>
          </tr>
            <?php } ?>
        </table> 
        <?php } ?>
